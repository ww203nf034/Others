...
listing$price <- as.numeric(gsub("\\$","", dt.listings$price))  
listing$host_response_rate <- as.numeric(gsub("\\%","", dt.listings$host_response_rate))   / 100
listing$host_acceptance_rate  <- as.numeric(gsub("\\%","", dt.listings$host_acceptance_rate)) / 100
